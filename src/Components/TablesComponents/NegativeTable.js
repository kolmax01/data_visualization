...
const rows = [
  createData("PM20221045", "WEB", "30-40 лет", "18:00", "98%"),
  createData("PM20221046", "CHATBOT", "женщины", "18:00", "98%"),
  // createData("PM20221047", "CHATBOT", "60+ лет", "20:00", "92%"),
];

export default function NegativeTable() {
  return (
    <Grid
      container
      direction="column"
